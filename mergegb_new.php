...
$dir_money = '/Users/ftn_scott/Documents/GitHub/qn5566.github.io/data/gballgame_new.txt';
...
//    var_dump($data_home,true);
    for ($z = 0; $z < $data_money['total']; $z++) {
        $money = $data_money['games'][$z];
//    var_dump($money);
//    die;
...
//        $save_2 = "0";
        ...
        for ($i = 0; $i < count($data_home); $i++) {
            ...
            for ($j = 0; $j < count($data_home[$i]); $j++) {
                ...
                if (in_array('Yōdanji', array($money['enTitle'], $money['twTitle'], $money['jpTitle'], $money['hkTitle']))) {
//                    echo '客製化:'.$money['enTitle'].'加入空值'.'<br>'.$data_home[$i][$j]['title'].'<br>';
                ...
                if (in_array('Starlink: Battle for Atlas - Deluxe edition', array($money['enTitle'], $money['twTitle'], $money['jpTitle'], $money['hkTitle']))) {
//                    echo '客製化:'.$money['enTitle'].'加入空值'.'<br>'.$data_home[$i][$j]['title'].'<br>';
                ...
                if (in_array('GUILTY GEAR XX ACCENT CORE PLUS R', array($money['enTitle'], $money['twTitle'], $money['jpTitle'], $money['hkTitle']))) {
//                    echo '客製化:'.$money['enTitle'].'加入空值'.'<br>'.$data_home[$i][$j]['title'].'<br>';
                ...
                if (in_array('GUILTY GEAR', array($money['enTitle'], $money['twTitle'], $money['jpTitle'], $money['hkTitle']))) {
//                    echo '客製化:'.$money['enTitle'].'加入空值'.'<br>'.$data_home[$i][$j]['title'].'<br>';
...
//                }
                ...
                if (in_array($data_home[$i][$j]['title'], array($money['enTitle'], $money['twTitle'], $money['jpTitle'], $money['hkTitle']))) {
